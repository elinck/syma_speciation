...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(fs, pts, prefix, "IIMG", IIMG, 3, 7,  param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)