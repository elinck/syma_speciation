...
def SI(params, ns, pts):
    ...
    phi=dadi.Integration.two_pops(phi,xx,Tdiv,nu1,nu2,m12=0,m21=0)
    model_fs = dadi.Spectrum.from_phi(phi, ns, (xx,xx))
    return model_fs

# define optimization parameters
pts = [40,50,60]
p_labels = "nu1, nu2, Tdiv"
upper = [20,20,15]
lower = [0.01,0.01,0.1]
reps = [10,20,50]
maxiters = [5,10,20]
...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(fs, pts, prefix, "SI", SI, 3, 3,  param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)