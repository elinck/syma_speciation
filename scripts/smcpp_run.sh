#!/bin/bash/
#see smcpp_boot.R for scripts to write bootstrapped lists of *.smc.gz files to ./boot/
...
do 
    ...
    mv tmp/model.final.json models_toro/`basename $boot .txt`.model.final.json
    rm tmp/*
done
